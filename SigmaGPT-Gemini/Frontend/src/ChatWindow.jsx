...
function ChatWindow() {
    const { prompt, setPrompt, setReply, currThreadId, setPrevChats, setNewChat, newChat } = useContext(MyContext);
    ...
    const getReply = async () => {
        ...
        try {
            ...
            console.log(err);
            setPrevChats(prev => [...prev, { role: "assistant", content: "Sorry, something went wrong. Please try again." }]);
        }
        ...
        <div className="chatWindow" onClick={() => isOpen && setIsOpen(false)}>
            <div className="navbar">
                ...
                <div className="navbar-right">
                    <button className="user-icon-btn" onClick={(e) => { e.stopPropagation(); setIsOpen(!isOpen); }}>
                        U
                    </button>
                </div>
            </div>
            ...
            <div className="chat-area" ref={chatAreaRef}>
                ...
                {loading && (
                    <div className="chats" style={{ width: "100%", maxWidth: "700px", margin: "0 auto", padding: "0 16px" }}>
